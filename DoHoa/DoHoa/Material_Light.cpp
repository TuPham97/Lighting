...
//char const *left_light, *right_light;
//char const *ico_material, *teapot_material, *torus_material;
//
//void output(GLfloat x, GLfloat y, char const *format, ...)
//{
//	va_list args;
//	char buffer[200], *p;
//
...
//}
//
//char const *material_select(int object, int value)
//{
//	glutPostRedisplay();
//	switch (value) {
//	case BRASS:
